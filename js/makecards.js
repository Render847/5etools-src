...
class MakeCards extends BaseComponent {
	...
	_render_cardList () {
		...
		const wrpList = veT`<div class="w-100 h-100"></div>`;
		veT`<div class="ve-flex-col h-100 w-100 ve-overflow-y-auto mt-2 ve-overflow-x-hidden">${wrpList}</div>`.vee.appendTo(wrpContainer);
